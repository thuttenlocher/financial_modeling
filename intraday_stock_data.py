# -*- coding: utf-8 -*-
"""
Created on Wed Apr 29 20:22:16 2020
...
def job(frequency, period):
    ...
    df = pd.read_csv('C:/Users/exampleuser/Desktop/S&amp;P 500.csv')
    ...
    for ticker in tickers:
        try:
                ...
                x = np.array(pd.read_csv('https://finance.google.com/finance/getprices?i='+frequency+'&amp;p='+period+'d&amp;f=d,o,h,l,c,v&amp;q='+ticker,skiprows=7,header=None))
...
date = []
                ...
                #Create Stock Folder
                ticker_path = os.path.join("C:/Users/fdupu\Desktop/Personal/Python Projects/S&amp;P 500 Intraday Data/", ticker)
                if not os.path.exists(ticker_path):
                    os.makedirs(ticker_path)
 
                #Store CSV
                storage_path = os.path.join("C:/Users/fdupu/Desktop/Personal/Python Projects/S&amp;P 500 Intraday Data/", ticker, ticker+".csv")
 ...
 def store_data():
        ...
        df = pd.read_csv('C:/Users/fdupu/Desktop/Personal/Ticker Files/Index Tickers/S&amp;P 500.csv')
        tickers = df['Ticker'].values.tolist()
 
       for ticker in tickers:
            read_path = os.path.join("C:/Users/fdupu/Desktop/Personal/Python Projects/S&amp;P 500 Intraday Data/", ticker, ticker+".csv")
